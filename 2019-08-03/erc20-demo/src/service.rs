...
use erc20_demo_runtime::{self, opaque::Block, GenesisConfig, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	erc20_demo_runtime::api::dispatch,
	erc20_demo_runtime::native_version,
	include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/erc20_demo_runtime_wasm.compact.wasm")
);
