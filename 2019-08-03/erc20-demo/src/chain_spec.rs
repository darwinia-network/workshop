use erc20_demo_runtime::{
	AccountId, BalancesConfig, ConsensusConfig, Erc20DemoConfig, GenesisConfig, IndicesConfig, SudoConfig,
	TimestampConfig,
};
...
fn testnet_genesis(
	...
	GenesisConfig {
		consensus: Some(ConsensusConfig {
			code: include_bytes!(
				"../runtime/wasm/target/wasm32-unknown-unknown/release/erc20_demo_runtime_wasm.compact.wasm"
			)
			.to_vec(),
